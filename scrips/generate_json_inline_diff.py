...
#   {+added content+}
#
# Ignores indentation-only changes.
#
...
# Build lookup sets to suppress indentation-only changes
old_lines_without_indent = {line.lstrip() for line in old_text}
new_lines_without_indent = {line.lstrip() for line in new_text}
...
for line in difflib.ndiff(old_text, new_text):
    ...
    if line.startswith("- "):
        ...
        if content.lstrip() in new_lines_without_indent:
            continue
        ...
        if content.lstrip() in old_lines_without_indent:
            continue
...
# Write output
# This overwrites the existing file if it already exists.
...
print("Note     : Existing output file is overwritten.")
print("============================================")
print("")