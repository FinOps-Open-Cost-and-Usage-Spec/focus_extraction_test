...
diff --git a/specification/datasets/cost_and_usage/columns/chargeperiodstart.md b/specification/datasets/cost_and_usage/columns/chargeperiodstart.md
index a4b1bea3..9284e737 100644
--- a/specification/datasets/cost_and_usage/columns/chargeperiodstart.md
+++ b/specification/datasets/cost_and_usage/columns/chargeperiodstart.md
@@ -1,14 +1,13 @@
# Charge Period Start

Charge Period Start represents the [*inclusive start bound*](#glossary:inclusivestartbound) of a [*charge period*](#glossary:chargeperiod). For example, a time period where Charge Period Start is '2024-01-01T00:00:00Z' and [Charge Period [-End](#chargeperiodend)-]{+End](#datasets.costandusage.chargeperiodend)+} is '2024-01-02T00:00:00Z' includes [*charges*](#glossary:charge) for January 1 since Charge Period Start represents the *inclusive start bound*, but does not include *charges* for January 2 since Charge Period End represents the [*exclusive end bound*](#glossary:exclusiveendbound).

## Requirements

ChargePeriodStart [-adheres-]{+MUST adhere+} to the following requirements:
...
* ChargePeriodStart MUST conform to [-[DateTimeFormat](#date/timeformat)-]{+[DateTimeFormat](#attributes.date/timeformat)+} requirements.
